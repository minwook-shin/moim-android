...
//            val sdf = SimpleDateFormat("HH:mm:ss")
            ...
            App.INSTANCE.timelineArray.add(TimelineModel(FirebaseManager.getUserEmail()!!,"",contentView.chatEditText.text.toString(),cal.timeInMillis.toString(),FirebaseManager.getUserUid().toString()))
